...
| :--- | :--- | :--- |
| $\hat{r}^2$ | $\mathbf{0.921}$ | $\mathbf{0.938}$ |
| $\hat{\beta}_1 / \hat{\beta}_2$ | $\mathbf{87.822}$ | $\mathbf{111.458}$ |

**Conclusion:**

  * The **$95\%$ confidence interval for $\hat{r}^2$** is $(\mathbf{0.921}, \mathbf{0.938})$.
  * The **$95\%$ confidence interval for $\hat{\beta}_1 / \hat{\beta}_2$** is $(\mathbf{87.822}, \mathbf{111.458})$.
